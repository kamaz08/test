    ...
    UserComponent.prototype.onSubmit = function (formData) {
        ...
        switch (this.dbops) {
            case enum_1.DBOperation.create:
                this._userService.AddUser(formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.update:
                this._userService.EditUser(formData._value.Id, formData._value).subscribe(function (data) {
                    if (data == 1) {
            ...
            case enum_1.DBOperation.delete:
                this._userService.DeleteUser(formData._value.Id).subscribe(function (data) {
                    if (data == 1) {
